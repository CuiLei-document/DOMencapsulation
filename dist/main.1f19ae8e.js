...
console.log(div);
var text = dom.after(test, div);
var div2 = dom.create("</span>before</span>");
var before = dom.before(test, div2);
var div3 = dom.create("<div>\u513F\u5B50</div>");
dom.append(test, div3);
var div4 = dom.wrap(wrap, wrap2);
var remove = dom.remove(wrap);
console.log(remove);
var nodes = dom.empty(window.empty);
console.log(nodes);
var attr = dom.attr(empty, 'title', '你好我叫崔磊');
var attr1 = dom.attr(empty, "title");
console.log(attr1);
dom.text(empty, "\u4F60\u597D\uFF0C\u8FD9\u4E2A\u662F\u65B0\u7684\u5185\u5BB9");
var text2 = dom.text(empty);
console.log(text2);
...
var emptyDiv = dom.find("#empty")[0];
console.log(emptyDiv);
dom.class.add(empty, "red");
dom.class.add(fd, 'red');
var fd1 = dom.find('#fd')[0];
...
var es = dom.find('#each')[0];
dom.each(dom.children(es), function (n) {
  return dom.style(n, 'color', 'blue');
});
var e2 = dom.find('#e2')[0]; // console.log(e2)
